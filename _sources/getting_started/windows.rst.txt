...
1. `Git <https://git-scm.com/download/win>`_
   ...
   .. warning:: Git For Windows does not bundle a proper version of perl that supports Windows and does not support Windows file path syntax correctly. See reference to issue `here <https://kitware.com/cmake/cmake/issues/18766>`_
...
10. `Openssl <https://www.openssl.org>`_ (Recommended for building HTTP server with OpenSSL as TLS backend)
