...
static netw_callbacks callbacks = { .on_heartbeat = on_hb,
                                    .on_alert = on_alert,
                                    .on_err = on_error,
                                    .on_ctrlc = on_ctrlc };
...
{
    int err = netw_poll(linqd->netw, ms);
