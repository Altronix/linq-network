...
add_custom_command(
	OUTPUT ${deps_INSTALL_DIR}/include/klib/khash.h ${deps_INSTALL_DIR}/include/klib/klist.h
 	COMMAND ${CMAKE_COMMAND} -E copy ${CMAKE_SOURCE_DIR}/external/klib/khash.h ${deps_INSTALL_DIR}/include/klib
 	COMMAND ${CMAKE_COMMAND} -E copy ${CMAKE_SOURCE_DIR}/external/klib/klist.h ${deps_INSTALL_DIR}/include/klib)
