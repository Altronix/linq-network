...
flags = [
    ...
    "-I../../external/linq-common/libosal",
    "-I../../external/linq-common/libosal/platform/linux",
    "-I../../external/linq-common/libosal/unet",
    "-I../../external/linq-common/libcrypt/wolfssl",
    "-I../../external/linq-common/libuzmtp",
    "-I../../build/install/include",
    "-I../../test/_fixture",
    "-I../../test/_helpers",
    "-I../../test/_mocks/mock_czmq",
    "-I../../test/_mocks/mock_mongoose",
    "-I../../test/_mocks/mock_sqlite",
    "-I../../test/linq",
    "-I../../include",
    "-I../../src",
    "-I../../src/sys/mock",
